const addnewrowbutton = document.getElementById("addbtn")
...
addnewrowbutton.addEventListener("click", () => {
  ...
  <td><button class="save" onclick="submitdata(document.getElementById('stuname').value,document.getElementById('rollno').value,document.getElementById('subject').value,document.getElementById('marks').value,document.getElementById('markedby').value)">Save</button></td>
  </form>`
